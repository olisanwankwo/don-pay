    ...
    <div class="min-h-screen bg-gray-900 text-white relative">
      ...
      <div v-if="showProfileSidebar" class="profile-sidebar fixed right-0 w-64 h-full bg-gray-900 text-white transition-all duration-300 ease-in-out transform" :class="{ '-translate-x-full': !showProfileSidebar }">
        ...
        <div v-if="userInfo" class="px-6 py-4">
          ...
          <p v-if="userInfo && userInfo.phone" class="text-sm text-gray-400" style="margin-left: -4px;">Phone: {{ userInfo.phone }}</p>
        ...
        <div class="min-h-screen bg-gray-900 text-white">
          <div class="header flex justify-between items-center px-6 py-10">
            ...
            <h1 class="text-lg flex-2 text-center font-bold">Profile</h1>
            ...
            <div class="content p-6">
                <div>
                  ...
                  <div v-if="userInfo" class="mb-4">
                    <p v-if="userInfo && userInfo.name"><strong>Name:</strong> {{ userInfo.name }}</p>
                    <p v-if="userInfo && userInfo.phone_number"><strong>Phone Number:</strong> {{ userInfo.phone_number }}</p>
                    <p v-if="userInfo && userInfo.email"><strong>Email Address:</strong> {{ userInfo.email }}</p>
                    <button @click="signOut" class="bg-blue-500 hover:bg-blue-600 mt-2 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">
                        Logout
                      </button>
